...
def azure_matchbox(request):
  ...
  if userlookup[request.user.username] != None:
    ...
    data = {'matchbox_results':str(f' 1. {prediction[1]},    2.{prediction[2]},    3.{prediction[3]},    4.{prediction[4]} ')}
     
    return render(request, 'applicationpages/jobpostings.html', data)
